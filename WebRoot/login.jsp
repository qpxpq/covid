    ...
    <form action="<%=baseURL %>/login.do" id="loginForm" class="form-signin" name="loginForm" method="post">
        <div class="panel periodic-login">
            <div class="panel-body text-center">
                <p class="atomic-mass">大庆市疫情报备系统</p>
            ...
            <div class="text-center" style="padding:5px;">您还没有本网站的账号?请点击<a href="http://localhost:8080/covid/view/user/add_user.jsp">立即注册</a> </div>
            <%--
