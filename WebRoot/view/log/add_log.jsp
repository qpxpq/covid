...
<info:verifyField verifyFile="log.xml" />
	...
	$(function(){
		$("#addLogButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addLog").attr("action",baseURL + "/addLog.do");
			} else {
				alert("更新成功");
				$("#addLog").attr("action",baseURL + "/updateLog.do");
			}
			$("#addLog").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listLog.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">操作地址</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="logAddress" id="logAddress" value='${pageEntity.logAddress }'
				         		placeholder="请输入操作地址"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addLogButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
