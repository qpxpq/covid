...
<info:verifyField verifyFile="accusation.xml" />
<script type="text/javascript">
	$(function(){
		$("#addAccusationButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addAccusation").attr("action",baseURL + "/addAccusation.do");
			} else {
				alert("更新成功");
				$("#addAccusation").attr("action",baseURL + "/updateAccusation.do");
			}
			$("#addAccusation").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listAccusation.do";
		});
	});
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <form method="post"   id="addAccusation" >
  <!-- start: content -->
  <div id="content">
    <div class="panel">
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">举报标题</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="accusationName" id="accusationName" value='${pageEntity.accusationName }'
				         		placeholder="请输入举报标题" readonly="readonly"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">举报内容</label>
	                  <div class="col-sm-10">
						 <textarea readonly="readonly" style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="accusationContext" name="accusationContext">${pageEntity.accusationContext }</textarea>
	                  </div>
	                </div>
						<input type="hidden" name="userId" id="userId" value='${pageEntity.userId }' />
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">举报人</label>
	                  <div class="col-sm-10">
	                    <input type="text" readonly="readonly" name="userName" id="userName" value='${pageEntity.userName }'
				         		placeholder="请输入举报人"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="accusationType" id="accusationType" value='已处理' />
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addAccusationButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
