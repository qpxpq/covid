              ...
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="accusationName" id="accusationName" value='${pageEntity.accusationName }'
				         		placeholder="请输入手机号"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">身份证号</label>
	                  <div class="col-sm-10">
						 <textarea style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="accusationContext" name="accusationContext">${pageEntity.accusationContext }</textarea>
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="accusationType" id="accusationType" value='审核中' />
