...
<script type="text/javascript">
	...
	function selectAccusation(){
		var obj = $('input[name="selectAccusationRadio"]:checked');
		var json = {};
			json["accusationName"] = $(obj).attr("accusationName");
			json["accusationContext"] = $(obj).attr("accusationContext");
			...
			json["accusationType"] = $(obj).attr("accusationType");
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listAccusation.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">申请标题：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="accusationName" name="accusationName" value="${searchList.accusationName }" 
          	 			class="text_add" style=" width:120px"  />
             </div>
			 <label class="col-sm-1 control-label text-right">申请人：</label>
			 <div class="col-sm-2">
	      ...
	      <div class="col-sm-2">
	      <info:dropDown dictionaryType="accusationType" name="accusationType"  defaultValue="${searchList.accusationType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectAccusation();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">申请内容</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectAccusationRadio" 
					          	  			accusationName='${listObject.accusationName }'
					          	  			accusationContext='${listObject.accusationContext }'
					          	  			...
					          	  			accusationType='${listObject.accusationType }'
				        		...
				        		<td class="center">${listObject.accusationName }</td>
				        		<td class="center">${listObject.accusationContext }</td>
				        		...
				        		<td class="center">${listObject.accusationType }</td>
					       </tr>
					      </c:forEach>
					      <tr>
