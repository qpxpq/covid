...
<script type="text/javascript">
	...
	function selectRegister(){
		var obj = $('input[name="selectRegisterRadio"]:checked');
		var json = {};
			...
			json["tw"] = $(obj).attr("tw");
			json["lc"] = $(obj).attr("lc");
			json["otherInfo"] = $(obj).attr("otherInfo");
			 ...
			 <div class="col-sm-2">
			 	<input type="text" id="name" name="name" value="${searchList.name }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectRegister();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectRegisterRadio" 
					          	  			name='${listObject.name }'
					          	  			mobile='${listObject.mobile }'
					          	  			address='${listObject.address }'
					          	  			tw='${listObject.tw }'
					          	  			lc='${listObject.lc }'
					          	  			otherInfo='${listObject.otherInfo }'
