...
<info:verifyField verifyFile="register.xml" />
<script type="text/javascript">
	$(function(){
		$("#addRegisterButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addRegister").attr("action",baseURL + "/addRegister.do");
			} else {
				alert("更新成功");
				$("#addRegister").attr("action",baseURL + "/updateRegister.do");
			}
			$("#addRegister").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listRegister.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
          <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="name" id="name" value='${pageEntity.name }'
				         		placeholder="请输入名称"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">来处</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="lc" id="lc" value='${pageEntity.lc }'
				         		placeholder="请输入来处"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">其他信息</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="otherInfo" id="otherInfo" value='${pageEntity.otherInfo }'
				         		placeholder="请输入其他信息"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addRegisterButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
