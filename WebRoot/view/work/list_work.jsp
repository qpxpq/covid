...
<script type="text/javascript">
	function delteWork(id){
		alert("删除成功");
		var url = baseURL + "/delteWork.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/work/import_work.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/work/add_work.jsp";
		window.location.href = url;
	}
</script>
</head>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="20%">地址</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	...
					        	<td class="center">
					         		<a href="<%=baseURL %>/findWork.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>|
         		                    <a href="javascript:delteWork('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportWork.do";
    var form = $("<form></form>");
