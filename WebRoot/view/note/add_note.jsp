...
<info:verifyField verifyFile="note.xml" />
	...
	$(function(){
		$("#addNoteButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addNote").attr("action",baseURL + "/addNote.do");
			} else {
				alert("更新成功");
				$("#addNote").attr("action",baseURL + "/updateNote.do");
			}
			$("#addNote").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listNote.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
          <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">帖子内容</label>
	                  <div class="col-sm-10">
						 <textarea style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="noteContext" name="noteContext">${pageEntity.noteContext }</textarea>
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addNoteButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
