...
<script type="text/javascript">
	...
	function selectNews(){
		var obj = $('input[name="selectNewsRadio"]:checked');
		var json = {};
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">消息标题：</label>
			 <div class="col-sm-2">
			 ...
			 <div class="col-sm-2">
			 	<input type="text" id="userName" name="userName" value="${searchList.userName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectNews();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">消息标题</th>
						  <th  class="sorting" width="10%">消息内容</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectNewsRadio" 
