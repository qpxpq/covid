...
<info:verifyField verifyFile="news.xml" />
	...
	$(function(){
		$("#addNewsButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addNews").attr("action",baseURL + "/addNews.do");
			} else {
				alert("更新成功");
				$("#addNews").attr("action",baseURL + "/updateNews.do");
			}
			$("#addNews").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listNews.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">消息标题</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="messageName" id="messageName" value='${pageEntity.messageName }'
				         		placeholder="请输入消息标题"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">消息内容</label>
	                  <div class="col-sm-10">
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addNewsButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
