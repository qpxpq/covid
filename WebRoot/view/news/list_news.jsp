...
<script type="text/javascript">
	function delteNews(id){
		alert("删除成功");
		var url = baseURL + "/delteNews.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/news/import_news.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/news/add_news.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listNews.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">消息管理管理</h3>
        </div>
      </div>
    </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="15%">消息标题</th>
						  <th  class="sorting" width="20%">消息内容</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	...
					        	<td class="center">
					         		<%-- <a href="<%=baseURL %>/findNews.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		| --%>
         		<a href="javascript:delteNews('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportNews.do";
    var form = $("<form></form>");
