...
<script type="text/javascript">
	...
	function selectAntiepidemic(){
		var obj = $('input[name="selectAntiepidemicRadio"]:checked');
		var json = {};
			json["antiepidemicName"] = $(obj).attr("antiepidemicName");
			json["antiepidemicContext"] = $(obj).attr("antiepidemicContext");
			json["antiepidemicYq"] = $(obj).attr("antiepidemicYq");
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">防疫信息标题：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="antiepidemicName" name="antiepidemicName" value="${searchList.antiepidemicName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectAntiepidemic();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">防疫信息描述</th>
						  <th  class="sorting" width="10%">防疫信息要求</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectAntiepidemicRadio" 
					          	  			antiepidemicName='${listObject.antiepidemicName }'
					          	  			antiepidemicContext='${listObject.antiepidemicContext }'
					          	  			antiepidemicYq='${listObject.antiepidemicYq }'
