...
<script type="text/javascript">
	function delteStack(id){
		alert("删除成功");
		var url = baseURL + "/delteStack.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/stack/import_stack.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/stack/add_stack.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listStack.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">健康码记录管理</h3>
        </div>
      </div>
    </div>
    <div class="col-md-12 padding-0 form-element">
      <div class="col-md-12">
       <div class="panel form-element-padding">
	      ...
	      <div class="col-sm-2">
	      <info:dropDown dictionaryType="stackType" name="stackType"  defaultValue="${searchList.stackType }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">图片</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center"><img alt="" src="<%=baseAddress %>/image/${listObject.fileURL }" style="width: 100px;height: 50px;"></td>
				        		<td class="center">${listObject.stackType }</td>
					        	...
					        	<td class="center">
					         		<a href="<%=baseURL %>/findStack.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteStack('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportStack.do";
    var form = $("<form></form>");
