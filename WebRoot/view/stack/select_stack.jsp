...
<script type="text/javascript">
	...
	function selectStack(){
		var obj = $('input[name="selectStackRadio"]:checked');
		var json = {};
			json["name"] = $(obj).attr("name");
			json["tw"] = $(obj).attr("tw");
			json["fileName"] = $(obj).attr("fileName");
			json["fileURL"] = $(obj).attr("fileURL");
			json["stackType"] = $(obj).attr("stackType");
	      ...
	      <info:dropDown dictionaryType="stackType" name="stackType"  defaultValue="${searchList.stackType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectStack();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectStackRadio" 
					          	  			name='${listObject.name }'
					          	  			tw='${listObject.tw }'
					          	  			fileName='${listObject.fileName }'
					          	  			fileURL='${listObject.fileURL }'
					          	  			stackType='${listObject.stackType }'
