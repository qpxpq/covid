...
<script type="text/javascript">
	function delteDivergence(id){
		alert("删除成功");
		var url = baseURL + "/delteDivergence.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/divergence/import_divergence.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/divergence/add_divergence.jsp";
		window.location.href = url;
	}
</script>
</head>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="30%">登记内容</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	...
					        	<td class="center">
					         		<a href="<%=baseURL %>/findDivergence.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteDivergence('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportDivergence.do";
    var form = $("<form></form>");
