...
<script type="text/javascript">
	...
	function selectVisit(){
		var obj = $('input[name="selectVisitRadio"]:checked');
		var json = {};
			json["visitName"] = $(obj).attr("visitName");
			json["visitSy"] = $(obj).attr("visitSy");
			json["visitRs"] = $(obj).attr("visitRs");
			json["visitDate"] = $(obj).attr("visitDate");
  ...
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">来访管理管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">来访人员：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="visitName" name="visitName" value="${searchList.visitName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectVisit();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">来访人员</th>
						  <th  class="sorting" width="10%">事由</th>
						  <th  class="sorting" width="10%">人数</th>
						  <th  class="sorting" width="10%">来访时间</th>
						  <th  class="sorting" width="10%">登记人</th>
						  <th  class="sorting" width="10%">登记时间</th>
                        </tr>
                      </thead>
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectVisitRadio" 
					          	  			visitName='${listObject.visitName }'
					          	  			visitSy='${listObject.visitSy }'
					          	  			visitRs='${listObject.visitRs }'
					          	  			visitDate='${listObject.visitDate }'
				        		...
				        		<td class="center">${listObject.visitName }</td>
				        		<td class="center">${listObject.visitSy }</td>
				        		<td class="center">${listObject.visitRs }</td>
				    			<td class="center"><fmt:formatDate value="${listObject.visitDate }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
