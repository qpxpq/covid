...
<info:verifyField verifyFile="visit.xml" />
	...
	$(function(){
		$("#addVisitButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addVisit").attr("action",baseURL + "/addVisit.do");
			} else {
				alert("更新成功");
				$("#addVisit").attr("action",baseURL + "/updateVisit.do");
			}
			$("#addVisit").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listVisit.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">来访人员</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="visitName" id="visitName" value='${pageEntity.visitName }'
				         		placeholder="请输入来访人员"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">事由</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="visitSy" id="visitSy" value='${pageEntity.visitSy }'
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="visitRs" id="visitRs" value='${pageEntity.visitRs }'
				         		placeholder="请输入人数"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">来访时间</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="visitDate" onclick="WdatePicker()" id="visitDate" value='<fmt:formatDate value="${pageEntity.visitDate }" pattern="yyyy-MM-dd HH:mm:ss" />'
						         placeholder="请选择来访时间"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addVisitButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
