...
<info:verifyField verifyFile="conduct.xml" />
<script type="text/javascript">
	$(function(){
		$("#addConductButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addConduct").attr("action",baseURL + "/addConduct.do");
			} else {
				alert("更新成功");
				$("#addConduct").attr("action",baseURL + "/updateConduct.do");
			}
			$("#addConduct").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listConduct.do";
		});
	});
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <form method="post"   id="addConduct" >
  <!-- start: content -->
  <div id="content">
    <div class="panel">
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="conductName" id="conductName" value='${pageEntity.conductName }'
				         		placeholder="请输入宣传名称"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">宣传内容</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="conductContext" id="conductContext" value='${pageEntity.conductContext }'
				         		placeholder="请输入宣传内容"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addConductButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
