...
<script type="text/javascript">
	...
	function selectConduct(){
		var obj = $('input[name="selectConductRadio"]:checked');
		var json = {};
			json["conductName"] = $(obj).attr("conductName");
			json["conductContext"] = $(obj).attr("conductContext");
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">宣传名称：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="conductName" name="conductName" value="${searchList.conductName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectConduct();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectConductRadio" 
					          	  			conductName='${listObject.conductName }'
					          	  			conductContext='${listObject.conductContext }'
