...
<script type="text/javascript">
	$(function(){
		...
		$("#addNoBespokeButton").click(function(){
			$("#accusationType").val("不同意");
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="vaccinumName" id="vaccinumName" value='${pageEntity.vaccinumName }'
				         		placeholder="请输入疫苗名称" readonly="readonly"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">疫苗针次</label>
	                  <div class="col-sm-10">
	                  	<input type="text" placeholder="请输入疫苗针次" readonly="readonly"  class="col-xs-10 col-sm-5" name="vaccinumType" id="vaccinumType" value='${pageEntity.vaccinumType }' />
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="userName" id="userName" readonly="readonly" value='${pageEntity.userName }'
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="authorName" id="authorName" readonly="readonly" value='${workSession.workName }'
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="accusationType" id="accusationType" value='${pageEntity.accusationType }' />
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addBespokeButton" class="submit btn btn-danger" type="button">同意</button>
              <button id="addNoBespokeButton" class="submit btn btn-danger" type="button">不同意</button>
            </div>
        </div>
      </div>
    </div>
