            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <info:dropDown  dictionaryType="healthStatus" name="healthStatus" 
        									defaultValue='${pageEntity.healthStatus }' styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"  />
	                  </div>
	                </div>
					<div class="form-group">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">来源地</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="healthContext" id="healthContext" value='${pageEntity.healthContext }'
				         		placeholder="请输入来源地"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">目的地</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="fxdq" id="fxdq" value='${pageEntity.fxdq }'
				         		placeholder="请输入目的地"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">到达站</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="jtfs" id="jtfs" value='${pageEntity.jtfs }'
				         		placeholder="请输入到达站点"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="info" id="info" value='${pageEntity.info }'
				         		placeholder="请输入身份证号"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="healthType" id="healthType" value='申请中' />
