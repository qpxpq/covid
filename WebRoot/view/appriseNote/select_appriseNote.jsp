...
<script type="text/javascript">
	...
	function selectAppriseNote(){
		var obj = $('input[name="selectAppriseNoteRadio"]:checked');
		var json = {};
			json["noteId"] = $(obj).attr("noteId");
			json["noteName"] = $(obj).attr("noteName");
			json["appriseNote"] = $(obj).attr("appriseNote");
			 ...
			 <div class="col-sm-2">
			 	<input type="text" id="noteName" name="noteName" value="${searchList.noteName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectAppriseNote();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">回复时间</th>
                        </tr>
                      </thead>
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectAppriseNoteRadio" 
					          	  			noteId='${listObject.noteId }'
					          	  			noteName='${listObject.noteName }'
					          	  			appriseNote='${listObject.appriseNote }'
