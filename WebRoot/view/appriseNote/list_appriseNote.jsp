...
<script type="text/javascript">
	function delteAppriseNote(id){
		alert("删除成功");
		var url = baseURL + "/delteAppriseNote.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/appriseNote/import_appriseNote.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/appriseNote/add_appriseNote.jsp?noteId=${param.noteId }&noteName=${param.noteName }";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listAppriseNote.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">评论信息管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">回复内容：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="appriseNote" name="appriseNote" value="${searchList.appriseNote }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="40%">回复内容</th>
						  <th  class="sorting" width="10%">回复人</th>
						  <th  class="sorting" width="20%">回复时间</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.appriseNote }</td>
					        	...
					        	<td class="center">
					         	<a href="<%=baseURL %>/findAppriseNote.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		| 
         		<a href="javascript:delteAppriseNote('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportAppriseNote.do";
    var form = $("<form></form>");
