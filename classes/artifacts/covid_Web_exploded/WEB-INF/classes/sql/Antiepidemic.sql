...
-- ----------------------------
-- Table structure for `antiepidemic`
-- ----------------------------
DROP TABLE IF EXISTS `antiepidemic`;
CREATE TABLE `antiepidemic` (
  resourceId varchar(255)  NOT NULL,
		antiepidemicName  varchar(2000)     null,
		antiepidemicContext  varchar(2000)     null,
		antiepidemicYq  varchar(2000)     null,
