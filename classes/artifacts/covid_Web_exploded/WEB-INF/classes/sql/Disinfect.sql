...
-- ----------------------------
-- Table structure for `disinfect`
-- ----------------------------
DROP TABLE IF EXISTS `disinfect`;
CREATE TABLE `disinfect` (
  resourceId varchar(255)  NOT NULL,
		disinfectName  varchar(2000)     null,
		disinfectContext  varchar(2000)     null,
		...
		disinfectType  varchar(2000)     null,
