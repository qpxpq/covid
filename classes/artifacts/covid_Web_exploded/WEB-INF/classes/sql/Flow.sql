...
CREATE TABLE `flow` (
  resourceId varchar(255)  NOT NULL,
		...
		hz  varchar(2000)     null,
		hzMobile  varchar(2000)     null,
		flowDate  varchar(2000)     null,
		flowType  varchar(2000)     null,
		unitNo  varchar(2000)     null,
		flowContext  varchar(2000)     null,
