...
<script type="text/javascript">
	...
	function selectMessage(){
		var obj = $('input[name="selectMessageRadio"]:checked');
		var json = {};
			json["messageName"] = $(obj).attr("messageName");
			json["messageContext"] = $(obj).attr("messageContext");
			...
			json["messageType"] = $(obj).attr("messageType");
	      ...
	      <info:dropDown dictionaryType="messageType" name="messageType"  defaultValue="${searchList.messageType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectMessage();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectMessageRadio" 
					          	  			messageName='${listObject.messageName }'
					          	  			messageContext='${listObject.messageContext }'
					          	  			...
					          	  			messageType='${listObject.messageType }'
