...
<info:verifyField verifyFile="message.xml" />
	...
	$(function(){
		$("#addMessageButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addMessage").attr("action",baseURL + "/addMessage.do");
			} else {
				alert("更新成功");
				$("#addMessage").attr("action",baseURL + "/updateMessage.do");
			}
			$("#addMessage").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listMessage.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="messageName" id="messageName" value='${pageEntity.messageName }'
				         		placeholder="请输入咨询标题" readonly="readonly"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">咨询内容</label>
	                  <div class="col-sm-10">
						 <textarea readonly="readonly" style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="messageContext" name="messageContext">${pageEntity.messageContext }</textarea>
	                  </div>
	                </div>
						<input type="hidden" name="userId" id="userId" value='${pageEntity.userId }' />
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">咨询人</label>
	                  <div class="col-sm-10">
	                    <input type="text" readonly="readonly" name="userName" id="userName" value='${pageEntity.userName }'
				         		placeholder="请输入咨询人"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="messageType" id="messageType" value='已回复' />
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addMessageButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
