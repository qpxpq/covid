...
<script type="text/javascript">
	function delteHealth(id){
		alert("删除成功");
		var url = baseURL + "/delteHealth.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/health/import_health.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/health/add_health.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listHealth.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">健康信息管理</h3>
        </div>
      </div>
    </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	...
					        	<td class="center">
					         		<a href="<%=baseURL %>/findHealth.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteHealth('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportHealth.do";
    var form = $("<form></form>");
