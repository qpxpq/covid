...
<info:verifyField verifyFile="health.xml" />
<script type="text/javascript">
	$(function(){
		$("#addHealthButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addHealth").attr("action",baseURL + "/addHealth.do");
			} else {
				alert("更新成功");
				$("#addHealth").attr("action",baseURL + "/updateHealth.do");
			}
			$("#addHealth").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listHealth.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <info:dropDown  dictionaryType="healthStatus" name="healthType" 
        									defaultValue='${pageEntity.healthType }' styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"  />
	                  </div>
	                </div>
					<div class="form-group">
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="healthContext" id="healthContext" value='${pageEntity.healthContext }'
				         		placeholder="请输入描述"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addHealthButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
