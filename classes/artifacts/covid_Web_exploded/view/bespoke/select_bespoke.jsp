...
<script type="text/javascript">
	...
	function selectBespoke(){
		var obj = $('input[name="selectBespokeRadio"]:checked');
		var json = {};
			json["vaccinumId"] = $(obj).attr("vaccinumId");
	      ...
	      <info:dropDown dictionaryType="accusationType" name="accusationType"  defaultValue="${searchList.accusationType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectBespoke();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectBespokeRadio" 
					          	  			vaccinumId='${listObject.vaccinumId }'
