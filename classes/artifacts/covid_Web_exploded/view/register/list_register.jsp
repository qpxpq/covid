...
<script type="text/javascript">
	function delteRegister(id){
		alert("删除成功");
		var url = baseURL + "/delteRegister.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/register/import_register.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/register/add_register.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listRegister.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">信息登记管理</h3>
        </div>
      </div>
    </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="8%">名称</th>
						  <th  class="sorting" width="8%">电话</th>
						  <th  class="sorting" width="8%">地址</th>
						  <th  class="sorting" width="8%">体温</th>
						  <th  class="sorting" width="8%">来处</th>
						  <th  class="sorting" width="10%">其他信息</th>
						  <th  class="sorting" width="8%">登记人</th>
						  <th  class="sorting" width="20%">登记时间</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.lc }</td>
				        		<td class="center">${listObject.otherInfo }</td>
					        	...
					        	<td class="center">
					         		<a href="<%=baseURL %>/findRegister.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteRegister('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportRegister.do";
    var form = $("<form></form>");
