...
<info:verifyField verifyFile="apply.xml" />
<script type="text/javascript">
	$(function(){
		$("#addApplyButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addApply").attr("action",baseURL + "/addApply.do");
			} else {
				alert("更新成功");
				$("#addApply").attr("action",baseURL + "/updateApply.do");
			}
			$("#addApply").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listApply.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="applyName" id="applyName" value='${pageEntity.applyName }'
				         		placeholder="请输入申请标题" readonly="readonly"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">申请内容</label>
	                  <div class="col-sm-10">
						 <textarea readonly="readonly" style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="applyContext" name="applyContext">${pageEntity.applyContext }</textarea>
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" readonly="readonly" name="userName" id="userName" value='${pageEntity.userName }'
				         		placeholder="请输入申请人"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
						...
						<input type="hidden" name="applyType" id="applyType" value='已处理' />
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addApplyButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
