...
<script type="text/javascript">
	...
	function selectApply(){
		var obj = $('input[name="selectApplyRadio"]:checked');
		var json = {};
			json["applyName"] = $(obj).attr("applyName");
			json["applyContext"] = $(obj).attr("applyContext");
			...
			json["applyType"] = $(obj).attr("applyType");
	      ...
	      <info:dropDown dictionaryType="applyType" name="applyType"  defaultValue="${searchList.applyType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectApply();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectApplyRadio" 
					          	  			applyName='${listObject.applyName }'
					          	  			applyContext='${listObject.applyContext }'
					          	  			...
					          	  			applyType='${listObject.applyType }'
