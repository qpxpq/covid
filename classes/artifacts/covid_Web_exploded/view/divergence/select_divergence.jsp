...
<script type="text/javascript">
	...
	function selectDivergence(){
		var obj = $('input[name="selectDivergenceRadio"]:checked');
		var json = {};
			json["divergenceName"] = $(obj).attr("divergenceName");
			json["divergenceContext"] = $(obj).attr("divergenceContext");
			json["divergenceType"] = $(obj).attr("divergenceType");
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listDivergence.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">登记管理管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">登记标题：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="divergenceName" name="divergenceName" value="${searchList.divergenceName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectDivergence();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">登记标题</th>
						  <th  class="sorting" width="10%">登记内容</th>
						  <th  class="sorting" width="10%">登记类型</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectDivergenceRadio" 
					          	  			divergenceName='${listObject.divergenceName }'
					          	  			divergenceContext='${listObject.divergenceContext }'
					          	  			divergenceType='${listObject.divergenceType }'
				        		...
				        		<td class="center">${listObject.divergenceName }</td>
				        		<td class="center">${listObject.divergenceContext }</td>
				        		<td class="center">${listObject.divergenceType }</td>
