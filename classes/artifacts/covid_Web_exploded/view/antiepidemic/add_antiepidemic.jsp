...
<info:verifyField verifyFile="antiepidemic.xml" />
<script type="text/javascript">
	$(function(){
		$("#addAntiepidemicButton").click(function(){
			if(!Validator.vd()) return;
			var resourceId = $("#resourceId").val();
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addAntiepidemic").attr("action",baseURL + "/addAntiepidemic.do");
			} else {
				alert("更新成功");
				$("#addAntiepidemic").attr("action",baseURL + "/updateAntiepidemic.do");
			}
			$("#addAntiepidemic").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listAntiepidemic.do";
		});
	});
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <form method="post"   id="addAntiepidemic" >
  <!-- start: content -->
  <div id="content">
    <div class="panel">
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">防疫信息标题</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="antiepidemicName" id="antiepidemicName" value='${pageEntity.antiepidemicName }'
				         		placeholder="请输入防疫信息标题"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">防疫信息描述</label>
	                  <div class="col-sm-10">
						 <textarea style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="antiepidemicContext" name="antiepidemicContext">${pageEntity.antiepidemicContext }</textarea>
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">防疫信息要求</label>
	                  <div class="col-sm-10">
						 <textarea style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="antiepidemicYq" name="antiepidemicYq">${pageEntity.antiepidemicYq }</textarea>
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addAntiepidemicButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
