...
<script type="text/javascript">
	...
	function selectCovid(){
		var obj = $('input[name="selectCovidRadio"]:checked');
		var json = {};
			json["covidName"] = $(obj).attr("covidName");
			json["covidContext"] = $(obj).attr("covidContext");
			json["covidSc"] = $(obj).attr("covidSc");
			json["covidAddress"] = $(obj).attr("covidAddress");
			json["covidType"] = $(obj).attr("covidType");
	      ...
	      <info:dropDown dictionaryType="covidType" name="covidType"  defaultValue="${searchList.covidType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectCovid();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">标题</th>
						  <th  class="sorting" width="10%">内容</th>
						  <th  class="sorting" width="10%">措施</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectCovidRadio" 
					          	  			covidName='${listObject.covidName }'
					          	  			covidContext='${listObject.covidContext }'
					          	  			covidSc='${listObject.covidSc }'
					          	  			covidAddress='${listObject.covidAddress }'
					          	  			covidType='${listObject.covidType }'
