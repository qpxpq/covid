...
<info:verifyField verifyFile="stack.xml" />
	...
	$(function(){
		$("#addStackButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addStack").attr("action",baseURL + "/addStack.do");
			} else {
				alert("更新成功");
				$("#addStack").attr("action",baseURL + "/updateStack.do");
			}
			$("#addStack").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listStack.do";
		});
	});
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <form method="post"   id="addStack" enctype="multipart/form-data">
  <!-- start: content -->
  <div id="content">
    <div class="panel">
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
          <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">体温</label>
	                  <div class="col-sm-10">
	                    <input type="text" name="tw" id="tw" value='${pageEntity.tw }'
	                  ...
	                  <div class="col-sm-10">
						<input type="hidden" name="fileName" id="fileName" value='${pageEntity.fileName }'
						          		class="InputStyle"   />
						 <input type="hidden" name="fileURL" id="fileURL" value='${pageEntity.fileURL }'
						          		class="InputStyle"   />
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <info:dropDown  dictionaryType="stackType" name="stackType" 
        									defaultValue='${pageEntity.stackType }' styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"  />
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addStackButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
