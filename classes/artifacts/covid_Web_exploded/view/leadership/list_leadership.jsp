              ...
              <div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                    ...
                    <table style="font-size: 10px;" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="6%">健康状态</th>
						  <th  class="sorting" width="6%">体温</th>
						  <th  class="sorting" width="8%">描述</th>
						  <th  class="sorting" width="8%">风险地区</th>
						  <th  class="sorting" width="8%">交通方式</th>
						  <th  class="sorting" width="8%">其他信息</th>
						  <th  class="sorting" width="8%">用户名称</th>
						  <th  class="sorting" width="6%">审核人</th>
						  <th  class="sorting" width="20%">回复内容</th>
						  <th  class="sorting" width="6%">状态</th>
         		...
         		<a href="javascript:delteLeadership('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	...
					        	<c:if test="${role eq 'work' && listObject.healthType eq '申请中'}">
