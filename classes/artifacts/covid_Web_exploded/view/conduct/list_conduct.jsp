...
<script type="text/javascript">
	function delteConduct(id){
		alert("删除成功");
		var url = baseURL + "/delteConduct.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/conduct/import_conduct.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/conduct/add_conduct.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listConduct.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">宣传管理管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-2 control-label text-right">宣传名称：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="conductName" name="conductName" value="${searchList.conductName }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">宣传名称</th>
						  <th  class="sorting" width="40%">宣传内容</th>
						  <th  class="sorting" width="10%">创建人</th>
						  <th  class="sorting" width="20%">创建时间</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.conductName }</td>
				        		<td>${listObject.conductContext }</td>
					        	...
					        	<c:if test="${role eq 'work' }"> <td class="center">
					         		<a href="<%=baseURL %>/findConduct.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteConduct('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td></c:if>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportConduct.do";
    var form = $("<form></form>");
