...
<script type="text/javascript">
	...
	function selectDisinfect(){
		var obj = $('input[name="selectDisinfectRadio"]:checked');
		var json = {};
			json["disinfectName"] = $(obj).attr("disinfectName");
			json["disinfectContext"] = $(obj).attr("disinfectContext");
			...
			json["disinfectType"] = $(obj).attr("disinfectType");
	      ...
	      <info:dropDown dictionaryType="disinfectType" name="disinfectType"  defaultValue="${searchList.disinfectType }" 
	         	styleClass="height:40px;width:345px;border:solid 1px #ddd;color: rgb(204, 204, 204);"/>
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectDisinfect();" class="btn_search">确认选择</button>
                  </div>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectDisinfectRadio" 
					          	  			disinfectName='${listObject.disinfectName }'
					          	  			disinfectContext='${listObject.disinfectContext }'
					          	  			...
					          	  			disinfectType='${listObject.disinfectType }'
