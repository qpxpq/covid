...
<script type="text/javascript">
	function delteDisinfect(id){
		alert("删除成功");
		var url = baseURL + "/delteDisinfect.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/disinfect/import_disinfect.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/disinfect/add_disinfect.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listDisinfect.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">消毒申请管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <div class="col-sm-2">
			 	<input type="text" id="disinfectName" name="disinfectName" value="${searchList.disinfectName }" 
	      ...
	      <div class="col-sm-2">
	      <info:dropDown dictionaryType="disinfectType" name="disinfectType"  defaultValue="${searchList.disinfectType }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">消毒标题</th>
						  <th  class="sorting" width="20%">消毒内容</th>
						  <th  class="sorting" width="10%">消毒人</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.disinfectName }</td>
				        		<td class="center">${listObject.disinfectContext }</td>
				        		...
				        		<td class="center">${listObject.disinfectType }</td>
					        	<td class="center">
					         		
					         		<c:if test="${role eq 'user' && listObject.disinfectType eq '消毒中'}">
					         		<a href="<%=baseURL %>/findDisinfect.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteDisinfect('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</c:if>
					        	<c:if test="${role eq 'work' && listObject.disinfectType eq '消毒中'}">
					         		<a href="<%=baseURL %>/findDisinfect.do?id=${listObject.resourceId}&type=author" title="处理" class="link_icon">处理</a>
					        	</c:if>
					        	</td>
					       </tr>
					      </c:forEach>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportDisinfect.do";
    var form = $("<form></form>");
