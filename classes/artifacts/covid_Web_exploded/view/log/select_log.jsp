...
<script type="text/javascript">
	...
	function selectLog(){
		var obj = $('input[name="selectLogRadio"]:checked');
		var json = {};
			json["logAddress"] = $(obj).attr("logAddress");
			 ...
			 <div class="col-sm-2">
			 	<input type="text" id="logAddress" name="logAddress" value="${searchList.logAddress }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectLog();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">操作地址</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectLogRadio" 
					          	  			logAddress='${listObject.logAddress }'
