...
<script type="text/javascript">
	function delteLog(id){
		alert("删除成功");
		var url = baseURL + "/delteLog.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/log/import_log.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/log/add_log.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listLog.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">日志管理管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">操作地址：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="logAddress" name="logAddress" value="${searchList.logAddress }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="30%">操作地址</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.logAddress }</td>
					        	...
					        	<td class="center">
					         		<%-- <a href="<%=baseURL %>/findLog.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		| --%>
         		<a href="javascript:delteLog('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportLog.do";
    var form = $("<form></form>");
