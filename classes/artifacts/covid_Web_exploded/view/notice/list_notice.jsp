...
<script type="text/javascript">
	function delteNotice(id){
		alert("删除成功");
		var url = baseURL + "/delteNotice.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/notice/import_notice.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/notice/add_notice.jsp";
		window.location.href = url;
	}
</script>
</head>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-2 control-label text-right">公告名称：</label>
			 <div class="col-sm-2">
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="15%">公告名称</th>
						  <th  class="sorting" width="30%">公告内容</th>
					       ...
					       <tr role="row" class="even">
				    			...
				    			<td class="center"><fmt:formatDate value="${listObject.createTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
					        	 <c:if test="${role eq 'work' }"> <td class="center">
					         		<a href="<%=baseURL %>/findNotice.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteNotice('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td></c:if>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportNotice.do";
    var form = $("<form></form>");
