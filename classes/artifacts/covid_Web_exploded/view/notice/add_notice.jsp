...
<info:verifyField verifyFile="notice.xml" />
	...
	$(function(){
		$("#addNoticeButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addNotice").attr("action",baseURL + "/addNotice.do");
			} else {
				alert("更新成功");
				$("#addNotice").attr("action",baseURL + "/updateNotice.do");
			}
			$("#addNotice").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listNotice.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="noticeName" id="noticeName" value='${pageEntity.noticeName }'
				         		placeholder="请输入公告名称"  class="col-xs-10 col-sm-5"  />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label text-right">公告内容</label>
	                  <div class="col-sm-10">
						 <textarea style="height:80px;width:310px;border:solid 1px #ddd;color: rgb(204, 204, 204);" id="noticeContext" name="noticeContext">${pageEntity.noticeContext }</textarea>
	                  </div>
	                </div>
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addNoticeButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
