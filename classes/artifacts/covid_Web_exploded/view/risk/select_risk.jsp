...
<script type="text/javascript">
	...
	function selectRisk(){
		var obj = $('input[name="selectRiskRadio"]:checked');
		var json = {};
			json["riskName"] = $(obj).attr("riskName");
			json["riskType"] = $(obj).attr("riskType");
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-1 control-label text-right">风险地区名称：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="riskName" name="riskName" value="${searchList.riskName }" 
                  ...
                  <div class="col-sm-4">
                    ...
                    <button type="button"  onclick="selectRisk();" class="btn_search">确认选择</button>
                  </div>
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="10%">风险地区名称</th>
						  <th  class="sorting" width="10%">风险地区等级</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
					        	<td class="center">
					        		<input type="radio" name="selectRiskRadio" 
					          	  			riskName='${listObject.riskName }'
					          	  			riskType='${listObject.riskType }'
