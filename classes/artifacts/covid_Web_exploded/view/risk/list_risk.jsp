...
<script type="text/javascript">
	function delteRisk(id){
		alert("删除成功");
		var url = baseURL + "/delteRisk.do?id=" + id;
	...
	function importExcl(){
		var url = baseURL + "/view/risk/import_risk.jsp"
	...
	function addPage(){
		var url = baseURL + "/view/risk/add_risk.jsp";
		window.location.href = url;
	}
</script>
</head>
...
<div class="container-fluid mimin-wrapper"> 
  ...
  <!-- start: content -->
  <form  action="listRisk.do" method="post" id="splitPageForm">
  <div id="content">
    <div class="panel">
      <div class="panel-body">
        <div class="col-md-12">
          <h3 class="animated fadeInLeft">风险地区管理</h3>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
       <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;" id="searchTable">
			 ...
			 <label class="col-sm-4 control-label text-right">风险地区名称：</label>
			 <div class="col-sm-2">
			 	<input type="text" id="riskName" name="riskName" value="${searchList.riskName }" 
                    ...
                    <table class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0"  style="width: 100%;">
                      <thead>
                        <tr role="row">
						  ...
						  <th  class="sorting" width="20%">风险地区名称</th>
						  <th  class="sorting" width="20%">风险地区等级</th>
                      ...
                      <tbody>
                        <c:forEach items="${pagerList.pageList }" varStatus="status" var="listObject" >
					       <tr role="row" class="even">
				        		...
				        		<td class="center">${listObject.riskName }</td>
				        		<td class="center">${listObject.riskType }</td>
					        	...
					        	<c:if test="${role eq 'work' }"><td class="center">
					         		<a href="<%=baseURL %>/findRisk.do?id=${listObject.resourceId}" title="编辑" class="link_icon">编辑</a>
         		|
         		<a href="javascript:delteRisk('${listObject.resourceId}');" title="删除" class="link_icon">删除</a>
					        	</td></c:if>
					       </tr>
					      </c:forEach>
					      <tr>
...
<script type="text/javascript">
function ev_export(){
	var action = baseURL+"/exportRisk.do";
    var form = $("<form></form>");
