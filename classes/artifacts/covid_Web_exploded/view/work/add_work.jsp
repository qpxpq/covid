...
<info:verifyField verifyFile="work.xml" />
	...
	$(function(){
		$("#addWorkButton").click(function(){
			...
			if(resourceId == "" || resourceId == null){
				alert("新增成功");
				$("#addWork").attr("action",baseURL + "/addWork.do");
			} else {
				alert("更新成功");
				$("#addWork").attr("action",baseURL + "/updateWork.do");
			}
			$("#addWork").submit();
		});
		...
		$("#returnListButton").click(function(){
			window.location.href = baseURL + "/listWork.do";
		});
	});
</script>
</head>
      ...
      <div class="col-md-12 padding-0">
        <div class="col-md-12">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="workNo" id="workNo" value='${pageEntity.workNo }'
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" name="workName" id="workName" value='${pageEntity.workName }'
          ...
          <div class="col-md-12 text-center" style="margin:20px;">
              <button id="addWorkButton" class="submit btn btn-danger" type="button">保存</button>
            </div>
        </div>
      </div>
    </div>
